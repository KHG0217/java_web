...
<body>
	<div class="container">
		...
		<table class="table table-bordered">
			...
			<tr>
				<td colsapn="2">
					<textarea class="form-control" rows="10" disabled><%=dto.getContent() %></textarea>
				</td>
			</tr>
		</table>
		...
		<%if(dto.getWriter().equals(id)){ %>
			...
			<a href="${pageContext.request.contextPath}/cafe/private/delete.jsp?num=<%=dto.getNum()%>">삭제</a>
		<%} %>
	</div>
</body>
</html>